  ...
  methods: {
    ...
    getVideos: function getVideos() {
      ...
      _Services_api__WEBPACK_IMPORTED_MODULE_0__["default"].getVideos().then(function (response) {
        _this.vides = response.data.response;
      });
    },
        ...
        [
          _c("div", { staticClass: "projectVideo" }, [
            _c("img", {
              ...
              attrs: { src: "/storage/" + _vm.projekt.thumbnail },
              on: {
                mouseover: function($event) {
                  return _vm.DisplayText(_vm.projekt.id)
                },
                mouseleave: function($event) {
                  return _vm.HiddeText(_vm.projekt.id)
                },
                click: function($event) {
                  return _vm.redirect(_vm.projekt.naslovPosnetkaApi)
                }
              }
            }),
            _vm._v(" "),
            _c(
              ...
              [_vm._v(_vm._s(_vm.projekt.naslovPosnetka.toUpperCase()))]
            )
          ])
        ]
      )
